...
This repo contains migrator programs for switching metadata over to LibrePlex

Migrator Lite does NOT touch any existing metadata on legacy / other standards. It adds a parallel LibrePlex
metadata alongside the existing legacy ones in order to enable evaluation and ease eventual full migration.

A Lite migration is fully reversible and all rent is recoverable.
